export const generateSyntheticData = (profile) => {
  ...
  let txs = [
    { 
      id: 101, 
      desc: `${profile.incomeSource || 'Gig Work'} Payout`, 
      amount: isHighRisk ? 850 : isMediumRisk ? 1500 : 2000, 
      type: 'income', 
      status: 'Locked (20%)', 
      date: 'Today, 9:00 AM' 
    },
  ...
  if (isHighRisk) {
    txs.push(
      ...
      { id: 106, desc: 'Swiggy Order', amount: 450, type: 'expense', status: 'Approved', date: '2 days ago' }
    );
    ...
    txs.push(
      ...
      { id: 105, desc: 'SIP Auto-Debit', amount: 500, type: 'expense', status: 'Invested', date: '3 days ago' }
    );
  } else {
    txs.push(
      ...
      { id: 105, desc: 'Savings Transfer', amount: 1000, type: 'expense', status: 'Invested', date: '3 days ago' }
    );
  }
