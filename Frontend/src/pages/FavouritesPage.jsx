export const FavouritesPage = () => {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-4">Favourites</h1>
      <p className="text-gray-700">Your favourite problems and solutions.</p>
      <div className="mt-6 p-4 bg-gray-50 rounded-lg">
        <p className="text-gray-600">Favourites functionality coming soon...</p>
      </div>
    </div>
  );
};
